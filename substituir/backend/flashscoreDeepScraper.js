                ...
                nodes.forEach(node => {
                    try {
                        ...
                        results.push({
                            ...
                            match_id: id,
                            league,
                            homeTeam: home || 'Desconhecido',
                            awayTeam: away || 'Desconhecido',
    ...
    async extractAndSaveStats(match) {
        ...
        try {
            ...
            for (const stat of stats) {
                this.db.insertStat(match.match_id, 'full', stat.category, stat.home_value, stat.away_value);
            }
