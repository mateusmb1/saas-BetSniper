        ...
        <div className="w-full mt-10 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-surface-dark to-surface-darker p-5 rounded-2xl border border-white/5 relative overflow-hidden group">
              ...
              <button className="w-full bg-background-dark/50 border border-white/10 text-white h-12 rounded-full font-bold text-sm flex items-center justify-center gap-2 hover:bg-background-dark/80 transition-all">
